...
public class AccountAgeWitnessUtils {
    ...
    public void witnessDebugLog(Trade trade, @Nullable AccountAgeWitness myWitness) {
        ...
        checkNotNull(trade.getProcessModel().getBuyer().getPaymentAccountPayload());
        ...
        if (witness == null) {
            witness = isBuyer ?
                    accountAgeWitnessService.getMyWitness(trade.getProcessModel().getBuyer().getPaymentAccountPayload()) :
                    accountAgeWitnessService.getMyWitness(trade.getProcessModel().getSeller().getPaymentAccountPayload());
        ...
        log.info("AccountSigning debug log: " +
                ...
                trade.getId(),
                isBuyer,
                getWitnessDebugLog(trade.getProcessModel().getBuyer().getPaymentAccountPayload(),
                        trade.getContract().getBuyerPubKeyRing()),
                getWitnessDebugLog(trade.getProcessModel().getSeller().getPaymentAccountPayload(),
