...
//        });
            ...
            connectionManager.addListener(newConnection -> {
                setDaemonConnections(newConnection);
            });
        });
    }
...
//  moneroConnectionsManager.addListener(newConnection -> {
...
//  }
    ...
    private void setDaemonConnections(MoneroRpcConnection connection) {
