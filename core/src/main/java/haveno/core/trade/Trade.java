...
public abstract class Trade extends XmrWalletBase implements Tradable, Model, XmrConnectionListener {
     ...
     * then deleted once the payout tx reaches {@link #NUM_BLOCKS_PAYOUT_DELETED} confirmations. The
     * payout must be finalized (i.e. reach {@link #NUM_BLOCKS_PAYOUT_FINALIZED}) before deletion can occur.
     */
