...
public class HavenoUtils {
    ...
    private static final double TAKER_FEE_PCT_CRYPTO = 0.008;
    private static final double MAKER_FEE_PCT_TRADITIONAL = 0.001;
    private static final double TAKER_FEE_PCT_TRADITIONAL = 0.02;
    ...
    private static final int MAX_CONCURRENT_DAEMON_REQUESTS = 3; // limit long requests to daemon (e.g. sync, refresh pool) without fully serializing them
