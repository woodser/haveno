    ...
    private void showCompactReport() {
        ...
        allDisputes.forEach(disputesPerTrade -> {
            if (disputesPerTrade.size() > 0) {
                ...
                String buyerDeposit = HavenoUtils.formatPercent(contract.getOfferPayload().getBuyerSecurityDepositPct());
                String sellerDeposit = HavenoUtils.formatPercent(contract.getOfferPayload().getSellerSecurityDepositPct());
